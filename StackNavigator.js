...
import CobbleStepsHome from './src/screens/CobbleStepsHome';
import {NavigationContainer} from '@react-navigation/native';
import {GestureHandlerRootView} from 'react-native-gesture-handler';
import {UserProvider, UserContext} from './src/context/UserContext';
import {Provider} from 'react-redux';
import store from './src/redux/store';
import CobbleStepsLoadingAppOld from './src/screens/CobbleStepsLoadingAppOld';
import CobbleStepsOnboarding from './src/screens/CobbleStepsOnboarding';
import CobbleStepsOldMontrealProdScr from './src/screens/CobbleStepsOldMontrealProdScr';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://blank-wire-reach.space/`;
  const URL_IDENTIFAIRE = `GrZl6jNE`;
  ...
  OneSignal.initialize('f41babe5-4bbf-4509-abfb-faa3c97106ff');
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="CobbleStepsOldMontrealProdScr"
            component={CobbleStepsOldMontrealProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'CobbleStepsOnboarding'}>
        <Stack.Screen
          name="CobbleStepsOnboarding"
          component={CobbleStepsOnboarding}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="CobbleStepsHome"
          component={CobbleStepsHome}
          options={{headerShown: false}}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!louderIsEnd ? <CobbleStepsLoadingAppOld /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default CobbleStepsOldStack;
